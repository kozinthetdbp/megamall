...
/**
 * Wavethemes Jmquickview Product View Helper
 *
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Wavethemes_Jmquickview_Helper_Product_View extends Mage_Catalog_Helper_Product_View
{
     /**
    ...
    public function initProductLayout($product, $controller)
    {
        ...
        //With Jmquickview, we cancle this action to use layout update from configs of Jmquickview
